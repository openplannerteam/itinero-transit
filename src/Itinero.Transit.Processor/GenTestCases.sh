...
dotnet run --ctlc https://graph.irail.be/sncb/connections https://graph.irail.be/sncb/stops "$DATE"T00:00:00 86400 --write-transit-db fixed-test-cases-sncb-"$DATE".transitdb
