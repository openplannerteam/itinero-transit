...
namespace Itinero.Transit.Data.Walks
{
    ...
    public interface IOtherModeGenerator
    {
        ...
        /// </summary>
        Journey<T> CreateDepartureTransfer<T>(IStopsReader stopsDb, Journey<T> buildOn, ulong timeWhenLeaving, (uint, uint) otherLocation) where T : IJourneyStats<T>;
        ...
        /// </summary>
        Journey<T> CreateArrivingTransfer<T>(IStopsReader stopsDb, Journey<T> buildOn, ulong timeWhenDeparting, (uint, uint) otherLocation) where T : IJourneyStats<T>;
