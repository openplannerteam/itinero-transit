...
{
    [Serializable]
    public struct OperatorId : InternalId
    {
        public static OperatorId Invalid = new OperatorId(uint.MaxValue, ulong.MaxValue);


        public uint DatabaseId { get; }
        public ulong LocalId { get; }

        public OperatorId(uint databaseId, ulong localId)
        {
        ...
        {
            return new OperatorId(databaseId, localId);
        }


        [Pure]
        public bool Equals(OperatorId other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is OperatorId other && Equals(other);
        }
