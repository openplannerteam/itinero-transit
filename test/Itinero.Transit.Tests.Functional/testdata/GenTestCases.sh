...
idp="/home/pietervdvn/werk/idp/src/IDP/bin/Release/netcoreapp2.1/linux-x64/IDP"
echo $idp
$idp --ctosm https://www.openstreetmap.org/relation/9413958 $1T00:00 86400 --write-transit-db fixed-test-cases-osm-CentrumbusBrugge$1.transitdb &

$idp --ctlc https://graph.irail.be/sncb/connections https://irail.be/stations/NMBS $1T00:00:00 86400 --write-transit-db fixed-test-cases-sncb-$1.transitdb &
