...
namespace Itinero.Transit.Tests.Algorithm.CSA
{
    public class ParetoFrontierTest
    {
        ...
        public void SimpleFrontierTest()
        {
            ...
            j = j.ChainForward(new SimpleConnection(0, loc, loc1, 0, 0, 10, 0, 0, new TripId(0, 0)));
            j = j.ChainForward(new SimpleConnection(0, loc1, loc2, 1, 20, 30, 1, 0, new TripId(0, 1)));
            ...
            direct = direct.ChainBackward(new SimpleConnection(2, loc, loc2, 2, 0, 40, 2, 0, new TripId(0, 2)));
            Assert.True(frontier.AddToFrontier(direct));


            var trSlow = new Journey<TransferMetric>(loc, 45, TransferMetric.Factory);

            trSlow = trSlow.ChainBackward(new SimpleConnection(0, loc1, loc2, 1, 20, 45, 3, 0, new TripId(0, 2)));
            trSlow = trSlow.ChainBackward(new SimpleConnection(0, loc1, loc2, 1, 20, 45, 3, 0, new TripId(0, 3)));
