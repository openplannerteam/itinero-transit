...
namespace Itinero.Transit.Tests.Core.Algorithms.CSA
{
    public class ParetoFrontierTest
    {
        ...
        public void AddToFrontier_OneSlowOneFasterJourney_JourneysAreMerged()
        {
            ...
            var atLocA =
                genesis.ChainBackward(new Connection(new ConnectionId(0,0), "0", locDep, locA, 10, 10, 0, 0, 0, new TripId(0, 0)));
            var atLocB =
        ...
        public void AddToFrontier_OneFastOneSlowJourney_SlowJourneyNotAdded()
        {
            ...
            j = j.ChainBackward(new Connection(new ConnectionId(0,0), "01", loc1, loc2, 10, 20, 30, 1, 0, new TripId(0, 1)));
            j = j.ChainBackward(new Connection(new ConnectionId(0,0), "00", loc, loc1, 0, 10, 10, 0, 0, new TripId(0, 0)));
            ...
            direct = direct.ChainBackward(new Connection(new ConnectionId(0,2), "02", loc, loc2, 2, 0, 40, 2, 0, new TripId(0, 2)));
            Assert.True(frontier.AddToFrontier(direct));


            var trSlow = new Journey<TransferMetric>(loc, 45, TransferMetric.Factory);

            trSlow = trSlow.ChainBackward(new Connection(new ConnectionId(0,0), "03", loc1, loc2, 1, 20, 45, 3, 0, new TripId(0, 2)));
            trSlow = trSlow.ChainBackward(new Connection(new ConnectionId(0,0), "04", loc1, loc2, 1, 20, 45, 3, 0, new TripId(0, 3)));
        ...
        public void ExtendFrontierBackwards_Frontier_ExpectsExtendedFrontier()
        {
            ...
            var extended = loc0Frontier.ExtendFrontierBackwards(
                ...
                new DummyReader(),
                new Connection(new ConnectionId(0, 6), "6", loc3, loc0, 45, 10, 0, 0, 0, new TripId(0, 1)),
